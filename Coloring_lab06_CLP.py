#graph coloring algorithm convert it into Adjacency List
class GraphColoring:
...
if __name__ == "__main__":
    ...
    graph = [
        ...
        [0, 1, 2, 4, 5],    # South Australia (index 3) connects to New South Wales (0), Victoria (1), Queensland (2), Northern Territory (4), and Western Australia (5)
        [2, 3, 5],          # Northern Territory (index 4) connects to Queensland (2), South Australia (3), and Western Australia (5)
        [3, 4]              # Western Australia (index 5) connects to South Australia (3) and Northern Territory (4)
    ]
